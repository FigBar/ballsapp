...
public class State {
    ...
    private Stack<BoardCell> moveStack;
     ...
     */
    public void makeMove(BoardCell move) {
        moveStack.push(move);
        this.board[move.getX()][move.getY()].index = this.currentIndex;
        this.zobristHash ^= zobristKeys[board[move.getX()][move.getY()]
                .index - 1][move.getX()][move.getY()];
     ...
     */
    public void undoMove(BoardCell move) {
        moveStack.pop();
        this.zobristHash ^= zobristKeys[board[move.getX()][move.getY()]
                .index - 1][move.getX()][move.getY()];
        this.board[move.getX()][move.getY()].index = 0;
        this.currentIndex = this.currentIndex == 1 ? 2 : 1;
    }
